# `pingcli pingone authorize application-resource-permissions get`
...
```
pingcli pingone authorize application-resource-permissions get [flags]
```
...
```
# Read a specific application resource permission
  pingcli pingone authorize application-resource-permissions get --environment-id <env-id> --application-resource-id <app-resource-id> --application-resource-permission-id <permission-id>
```
