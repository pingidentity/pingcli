# `pingcli pingone applications application-grants list`
...
```
pingcli pingone applications application-grants list [flags]
```
...
# List all application grants for an application in an environment
  pingcli pingone applications application-grants list --environment-id <env-id> --application-id <app-id>
```
