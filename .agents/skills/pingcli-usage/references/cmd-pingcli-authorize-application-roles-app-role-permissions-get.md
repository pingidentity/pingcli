# `pingcli authorize application-roles app-role-permissions get`
...
```
pingcli authorize application-roles app-role-permissions get [flags]
```
...
```
# Read a specific application role permission
  pingcli authorize application-roles app-role-permissions get --environment-id <env-id> --application-role-id <role-id> --permission-id <permission-id>
```
