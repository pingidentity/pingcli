# `pingcli pingone applications attribute-mappings template`
Generate an application attribute mapping JSON template

## Synopsis

Generate a JSON skeleton template for application attribute mapping create bodies

```
pingcli pingone applications attribute-mappings template [flags]
```
...
# Generate a template and save to a file
  pingcli pingone applications attribute-mappings template > body.json
...
Example workflow:
  pingcli pingone applications attribute-mappings template > body.json
  # edit body.json
  pingcli pingone applications attribute-mappings create --from-file body.json
```
