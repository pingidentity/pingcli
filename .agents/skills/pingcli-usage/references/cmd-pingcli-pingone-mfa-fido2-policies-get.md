# `pingcli pingone mfa fido2-policies get`
...
```
pingcli pingone mfa fido2-policies get [flags]
```
...
```
# Read a specific FIDO2 policy
  pingcli pingone mfa fido2-policies get --environment-id <env-id> --fido2-policy-id <policy-id>
```
