# `pingcli pingfederate idp sp-connections template`
Generate an SP connection JSON template

## Synopsis

Generate a JSON skeleton template for SP connection create or replace bodies

```
pingcli pingfederate idp sp-connections template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate idp sp-connections template > body.json

  # Edit the template, then create the SP connection
  pingcli pingfederate idp sp-connections create --from-file body.json
