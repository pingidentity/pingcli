# `pingcli pingfederate ping-one-connections create`
Create a new PingOne connection

## Synopsis

Create a new PingFederate PingOne connection

```
pingcli pingfederate ping-one-connections create [flags]
```

## Examples

```
# Create a new PingOne connection from a JSON file
