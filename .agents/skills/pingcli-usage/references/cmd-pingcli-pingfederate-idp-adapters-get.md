# `pingcli pingfederate idp adapters get`
Read a specific IDP adapter

## Synopsis

Read a specific PingFederate IDP adapter

```
pingcli pingfederate idp adapters get [flags]
```
...
```
# Read a specific IDP adapter
  pingcli pingfederate idp adapters get --id <id>
```
