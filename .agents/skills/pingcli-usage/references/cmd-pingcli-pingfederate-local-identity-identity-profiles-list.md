# `pingcli pingfederate local-identity identity-profiles list`
List all local identity profiles

## Synopsis

List all PingFederate local identity profiles

```
pingcli pingfederate local-identity identity-profiles list [flags]
```
