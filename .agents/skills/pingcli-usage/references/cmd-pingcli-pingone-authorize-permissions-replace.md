# `pingcli pingone authorize permissions replace`
...
```
pingcli pingone authorize permissions replace [flags]
```
...
# Replace an application resource permission from flags
  pingcli pingone authorize permissions replace --environment-id <env-id> --application-resource-id <app-resource-id> --application-resource-permission-id <permission-id> --action read --description "Read access"

  # Update an application resource permission from a JSON file (path flags are still required)
  pingcli pingone authorize permissions replace --environment-id <env-id> --application-resource-id <app-resource-id> --application-resource-permission-id <permission-id> --from-file permission.json
