# `pingcli pingone schemas attributes create`
Create a new schema attribute

## Synopsis

Create a new schema attribute in a PingOne environment schema

```
pingcli pingone schemas attributes create [flags]
```

## Examples

```
# Create a new schema attribute from a JSON file
