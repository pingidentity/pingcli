# `pingcli pingone rate-limit-ip-configs template`
Generate a rate limit IP configuration JSON template

## Synopsis

Generate a JSON skeleton template for rate limit IP configuration create bodies

```
pingcli pingone rate-limit-ip-configs template [flags]
```
...
# Generate a template and save to a file
  pingcli pingone rate-limit-ip-configs template > body.json
...
Example workflow:
  pingcli pingone rate-limit-ip-configs template > body.json
  # edit body.json
  pingcli pingone rate-limit-ip-configs create --from-file body.json
```
