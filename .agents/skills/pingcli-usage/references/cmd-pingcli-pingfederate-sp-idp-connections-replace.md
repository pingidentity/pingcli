# `pingcli pingfederate sp idp-connections replace`
Update an IdP connection

## Synopsis

Update (replace) a PingFederate SP IdP connection

```
pingcli pingfederate sp idp-connections replace [flags]
```

## Examples

```
# Update an IdP connection from a JSON file (--id is still required)
