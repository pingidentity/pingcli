# `pingcli authorize permissions template`
...
```
pingcli authorize permissions template [flags]
```
...
# Generate a template and save to a file
  pingcli authorize permissions template > permission.json
...
Example workflow:
  pingcli authorize permissions template > body.json
  # edit body.json
  pingcli authorize permissions create --from-file body.json
```
