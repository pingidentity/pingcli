# `pingcli pingfederate captcha-providers template`
Generate a CAPTCHA provider JSON template

## Synopsis

Generate a JSON skeleton template for CAPTCHA provider create or replace bodies

```
pingcli pingfederate captcha-providers template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate captcha-providers template > body.json

  # Edit the template, then create the CAPTCHA provider
  pingcli pingfederate captcha-providers create --from-file body.json
