# `pingcli pingone languages agreement-revisions create`
Create a new agreement language revision

## Synopsis

Create a new agreement language revision in a PingOne environment

```
pingcli pingone languages agreement-revisions create [flags]
```

## Examples

```
# Create a new agreement language revision from a JSON file
