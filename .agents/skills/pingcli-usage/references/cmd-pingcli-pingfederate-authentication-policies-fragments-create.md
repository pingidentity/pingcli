# `pingcli pingfederate authentication-policies fragments create`
Create a new authentication policy fragment

## Synopsis

Create a new PingFederate authentication policy fragment

```
pingcli pingfederate authentication-policies fragments create [flags]
```

## Examples

```
# Create a new authentication policy fragment from a JSON file
