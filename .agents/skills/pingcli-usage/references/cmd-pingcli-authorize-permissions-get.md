# `pingcli authorize permissions get`
...
```
pingcli authorize permissions get [flags]
```
...
```
# Read a specific application resource permission
  pingcli authorize permissions get --environment-id <env-id> --application-resource-id <app-resource-id> --application-resource-permission-id <permission-id>
```
