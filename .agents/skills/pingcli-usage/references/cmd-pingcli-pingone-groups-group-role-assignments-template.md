# `pingcli pingone groups group-role-assignments template`
...
```
pingcli pingone groups group-role-assignments template [flags]
```
...
# Generate a template and save to a file
  pingcli pingone groups group-role-assignments template > body.json
...
Example workflow:
  pingcli pingone groups group-role-assignments template > body.json
  # edit body.json
  pingcli pingone groups group-role-assignments create --from-file body.json
```
