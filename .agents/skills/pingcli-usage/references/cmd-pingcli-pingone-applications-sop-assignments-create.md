# `pingcli pingone applications sop-assignments create`
Create a new sign-on policy assignment

## Synopsis

Create a new sign-on policy assignment for an application in a PingOne environment

```
pingcli pingone applications sop-assignments create [flags]
```
