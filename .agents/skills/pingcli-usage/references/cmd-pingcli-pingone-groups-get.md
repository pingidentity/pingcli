# `pingcli pingone groups get`
Read a specific group

## Synopsis

Read a specific group in a PingOne environment

```
pingcli pingone groups get [flags]
```
...
```
# Read a specific group
  pingcli pingone groups get --environment-id <env-id> --group-id <group-id>
```
