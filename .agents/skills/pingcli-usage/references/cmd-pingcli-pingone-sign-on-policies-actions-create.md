# `pingcli pingone sign-on-policies actions create`
Create a new sign-on policy action

## Synopsis

Create a new sign-on policy action in a PingOne sign-on policy

```
pingcli pingone sign-on-policies actions create [flags]
```
