# `pingcli pingfederate oauth clients get`
Read a specific OAuth client

## Synopsis

Read a specific PingFederate OAuth client

```
pingcli pingfederate oauth clients get [flags]
```
...
```
# Read a specific OAuth client
  pingcli pingfederate oauth clients get --id <id>
```
