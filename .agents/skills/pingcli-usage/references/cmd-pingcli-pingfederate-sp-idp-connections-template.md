# `pingcli pingfederate sp idp-connections template`
Generate an IdP connection JSON template

## Synopsis

Generate a JSON skeleton template for IdP connection create or replace bodies

```
pingcli pingfederate sp idp-connections template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate sp idp-connections template > body.json

  # Edit the template, then create the IdP connection
  pingcli pingfederate sp idp-connections create --from-file body.json
