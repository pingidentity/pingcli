# `pingcli pingfederate authentication-api applications get`
Read a specific authentication API application

## Synopsis

Read a specific PingFederate authentication API application

```
pingcli pingfederate authentication-api applications get [flags]
```
...
```
# Read a specific authentication API application
  pingcli pingfederate authentication-api applications get --id <id>
```
