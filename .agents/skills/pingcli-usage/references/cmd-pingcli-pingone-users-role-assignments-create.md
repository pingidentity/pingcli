# `pingcli pingone users role-assignments create`
Create a new user role assignment

## Synopsis

Create a new user role assignment in a PingOne environment

```
pingcli pingone users role-assignments create [flags]
```

## Examples

```
# Create a new user role assignment from a JSON file
