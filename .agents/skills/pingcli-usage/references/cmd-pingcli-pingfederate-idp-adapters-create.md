# `pingcli pingfederate idp adapters create`
Create a new IDP adapter

## Synopsis

Create a new PingFederate IDP adapter

```
pingcli pingfederate idp adapters create [flags]
```

## Examples

```
# Create a new IDP adapter from a JSON file
