# `pingcli authorize api-servers api-server-operations list`
...
```
pingcli authorize api-servers api-server-operations list [flags]
```
...
# List all API server operations for an API server in an environment
  pingcli authorize api-servers api-server-operations list --environment-id <env-id> --api-server-id <server-id>
```
