# `pingcli credentials types template`
...
```
pingcli credentials types template [flags]
```
...
# Generate a template and save to a file
  pingcli credentials types template > body.json
...
Example workflow:
  pingcli credentials types template > body.json
  # edit body.json
  pingcli credentials types create --from-file body.json
```
