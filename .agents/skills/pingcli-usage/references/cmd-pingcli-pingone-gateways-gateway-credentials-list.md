# `pingcli pingone gateways gateway-credentials list`
...
```
pingcli pingone gateways gateway-credentials list [flags]
```
...
# List all gateway credentials for a gateway
  pingcli pingone gateways gateway-credentials list --environment-id <env-id> --gateway-id <gateway-id>
```
