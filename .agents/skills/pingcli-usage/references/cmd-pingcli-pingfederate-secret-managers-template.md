# `pingcli pingfederate secret-managers template`
Generate a secret manager JSON template

## Synopsis

Generate a JSON skeleton template for secret manager create or replace bodies

```
pingcli pingfederate secret-managers template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate secret-managers template > body.json

  # Edit the template, then create the secret manager
  pingcli pingfederate secret-managers create --from-file body.json
