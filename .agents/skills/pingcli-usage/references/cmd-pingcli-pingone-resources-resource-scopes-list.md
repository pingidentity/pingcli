# `pingcli pingone resources resource-scopes list`
...
```
pingcli pingone resources resource-scopes list [flags]
```
...
# List all resource scopes for a resource in an environment
  pingcli pingone resources resource-scopes list --environment-id <env-id> --resource-id <resource-id>
```
