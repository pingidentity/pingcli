# `pingcli davinci applications flow-policies`
...
```
pingcli davinci applications flow-policies [flags]
```
...
| `pingcli davinci applications flow-policies template` | Generate a DaVinci flow policy JSON template | [`cmd-pingcli-davinci-applications-flow-policies-template.md`](cmd-pingcli-davinci-applications-flow-policies-template.md) |
