# `pingcli pingone schemas get`
Read a specific schema

## Synopsis

Read a specific PingOne schema

```
pingcli pingone schemas get [flags]
```
...
```
# Read a specific schema
  pingcli pingone schemas get --environment-id <env-id> --schema-id <schema-id>
```
...
| `-s, --schema-id string` | `` | The schema ID |
