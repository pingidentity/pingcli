# `pingcli pingfederate sp idp-connections delete`
Delete an IdP connection

## Synopsis

Delete a PingFederate SP IdP connection

```
pingcli pingfederate sp idp-connections delete [flags]
```
...
```
# Delete an IdP connection
  pingcli pingfederate sp idp-connections delete --id <id>
```
