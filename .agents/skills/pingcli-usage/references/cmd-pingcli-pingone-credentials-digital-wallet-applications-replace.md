...
# Replace a digital wallet application from flags
  pingcli pingone credentials digital-wallet-applications replace --environment-id <env-id> --digital-wallet-application-id <dwa-id> --name "My Wallet App" --app-open-url "https://example.com/open"
