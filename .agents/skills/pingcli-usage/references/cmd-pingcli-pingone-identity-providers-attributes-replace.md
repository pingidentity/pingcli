# `pingcli pingone identity-providers attributes replace`
Replace an identity provider attribute

## Synopsis

Replace (PUT) an identity provider attribute in a PingOne environment

```
pingcli pingone identity-providers attributes replace [flags]
```
