# `pingcli pingfederate server-settings audit-log-settings template`
Generate an audit log settings JSON template

## Synopsis

Generate a JSON skeleton template for audit log settings replace bodies

```
pingcli pingfederate server-settings audit-log-settings template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate server-settings audit-log-settings template > body.json

  # Edit the template, then update the audit log settings
  pingcli pingfederate server-settings audit-log-settings replace --from-file body.json
