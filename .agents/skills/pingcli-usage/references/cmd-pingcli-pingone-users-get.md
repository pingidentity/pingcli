# `pingcli pingone users get`
Read a specific user

## Synopsis

Read a specific user in a PingOne environment

```
pingcli pingone users get [flags]
```
...
```
# Read a specific user
  pingcli pingone users get --environment-id <env-id> --user-id <user-id>
```
