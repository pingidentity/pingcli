# `pingcli mfa fido2-policies apply`
...
```
pingcli mfa fido2-policies apply [flags]
```
...
# Create or update a FIDO2 policy (body supplies name and required fields)
  pingcli mfa fido2-policies apply --environment-id <env-id> --from-file fido2-policy.json
