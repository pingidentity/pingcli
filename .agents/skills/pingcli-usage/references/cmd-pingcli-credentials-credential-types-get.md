# `pingcli credentials credential-types get`
...
```
pingcli credentials credential-types get [flags]
```
...
```
# Read a specific credential type
  pingcli credentials credential-types get --environment-id <env-id> --credential-type-id <credential-type-id>
```
