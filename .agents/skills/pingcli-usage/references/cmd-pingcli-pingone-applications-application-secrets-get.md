# `pingcli pingone applications application-secrets get`
...
```
pingcli pingone applications application-secrets get [flags]
```
...
# Read the current application secret
  pingcli pingone applications application-secrets get --environment-id <env-id> --application-id <app-id>
```
