# `pingcli pingone groups role-assignments create`
Create a new group role assignment

## Synopsis

Create a new group role assignment in a PingOne environment

```
pingcli pingone groups role-assignments create [flags]
```

## Examples

```
# Create a new group role assignment from a JSON file
