# `pingcli pingfederate key-pairs signing delete`
Delete a signing key pair

## Synopsis

Delete a PingFederate signing key pair

```
pingcli pingfederate key-pairs signing delete [flags]
```
...
```
# Delete a signing key pair
  pingcli pingfederate key-pairs signing delete --id <id>
```
