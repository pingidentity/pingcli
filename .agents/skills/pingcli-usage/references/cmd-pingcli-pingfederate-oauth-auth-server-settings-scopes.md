# `pingcli pingfederate oauth auth-server-settings scopes`
Manage OAuth Authorization Server Settings scope collections

## Synopsis

Manage PingFederate OAuth Authorization Server Settings scope collections
