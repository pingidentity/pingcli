# `pingcli pingfederate authentication-policies fragments template`
Generate an authentication policy fragment JSON template

## Synopsis

Generate a JSON skeleton template for authentication policy fragment create or replace bodies

```
pingcli pingfederate authentication-policies fragments template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate authentication-policies fragments template > body.json

  # Edit the template, then create the authentication policy fragment
  pingcli pingfederate authentication-policies fragments create --from-file body.json
