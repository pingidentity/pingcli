# `pingcli pingone custom-admin-roles list`
List all custom admin roles

## Synopsis

List all custom admin roles in a PingOne environment

```
pingcli pingone custom-admin-roles list [flags]
```

## Examples

```
# List all custom admin roles in an environment
  pingcli pingone custom-admin-roles list --environment-id <env-id>
```
