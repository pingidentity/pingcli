# `pingcli pingone agreements create`
Create a new agreement

## Synopsis

Create a new agreement in a PingOne environment

```
pingcli pingone agreements create [flags]
```

## Examples

```
# Create a new agreement from a JSON file
