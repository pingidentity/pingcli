# `pingcli pingone sign-on-policies sop-actions list`
List all sign-on policy actions

## Synopsis

List all sign-on policy actions in a PingOne sign-on policy

```
pingcli pingone sign-on-policies sop-actions list [flags]
```

## Examples

```
# List all sign-on policy actions in a sign-on policy
  pingcli pingone sign-on-policies sop-actions list --environment-id <env-id> --sign-on-policy-id <sop-id>
```
