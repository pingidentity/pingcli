# `pingcli protect risk-policy-sets get`
...
```
pingcli protect risk-policy-sets get [flags]
```
...
```
# Read a specific risk policy set
  pingcli protect risk-policy-sets get --environment-id <env-id> --risk-policy-set-id <policy-set-id>
```
