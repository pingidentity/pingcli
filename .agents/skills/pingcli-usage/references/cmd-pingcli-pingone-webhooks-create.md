# `pingcli pingone webhooks create`
Create a new webhook

## Synopsis

Create a new webhook in a PingOne environment

```
pingcli pingone webhooks create [flags]
```

## Examples

```
# Create a new webhook from a JSON file
