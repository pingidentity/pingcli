# `pingcli pingone languages status create`
Create a new language localization status

## Synopsis

Create a new language localization status in a PingOne environment

```
pingcli pingone languages status create [flags]
```

## Examples

```
# Create a new language localization status from a JSON file
