# `pingcli pingfederate oauth clients template`
Generate an OAuth client JSON template

## Synopsis

Generate a JSON skeleton template for OAuth client create or replace bodies

```
pingcli pingfederate oauth clients template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate oauth clients template > body.json

  # Edit the template, then create the OAuth client
  pingcli pingfederate oauth clients create --from-file body.json
