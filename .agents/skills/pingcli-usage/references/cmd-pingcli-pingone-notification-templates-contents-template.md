# `pingcli pingone notification-templates contents template`
...
Select the desired delivery method with --template-type (one of: email, sms,
voice, push). Defaults to email when omitted.

```
pingcli pingone notification-templates contents template [flags]
```

## Examples

```
# Generate an email template and save to a file
  pingcli pingone notification-templates contents template --template-type email > body.json
...
Example workflow:
  pingcli pingone notification-templates contents template > body.json
  # edit body.json
  pingcli pingone notification-templates contents create --from-file body.json
```
...
| `--template-type string` | `` | The variant of the template to generate. One of: email, sms, voice, push. Defaults to "email". |
