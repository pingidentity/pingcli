# `pingcli protect risk-predictors get`
...
```
pingcli protect risk-predictors get [flags]
```
...
```
# Read a specific risk predictor
  pingcli protect risk-predictors get --environment-id <env-id> --risk-predictor-id <predictor-id>
```
