# `pingcli authorize application-roles app-role-permissions list`
...
```
pingcli authorize application-roles app-role-permissions list [flags]
```
...
# List all application role permissions for a role in an environment
  pingcli authorize application-roles app-role-permissions list --environment-id <env-id> --application-role-id <role-id>
```
