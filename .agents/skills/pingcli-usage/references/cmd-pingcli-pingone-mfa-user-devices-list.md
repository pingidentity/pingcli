# `pingcli pingone mfa user-devices list`
List all user MFA devices

## Synopsis

List all MFA devices enrolled for a user in a PingOne environment

```
pingcli pingone mfa user-devices list [flags]
```
...
# List all MFA devices for a user
  pingcli pingone mfa user-devices list --environment-id <env-id> --user-id <user-id>
```
