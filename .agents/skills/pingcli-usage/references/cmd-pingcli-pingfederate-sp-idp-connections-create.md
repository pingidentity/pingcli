# `pingcli pingfederate sp idp-connections create`
...
```
pingcli pingfederate sp idp-connections create [flags]
```
...
# Create a new IdP connection from a JSON file
  pingcli pingfederate sp idp-connections create --from-file idp-connection.json
