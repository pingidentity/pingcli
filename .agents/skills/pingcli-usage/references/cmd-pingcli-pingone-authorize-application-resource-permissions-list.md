# `pingcli pingone authorize application-resource-permissions list`
...
```
pingcli pingone authorize application-resource-permissions list [flags]
```
...
# List all permissions for an application resource
  pingcli pingone authorize application-resource-permissions list --environment-id <env-id> --application-resource-id <app-resource-id>
```
