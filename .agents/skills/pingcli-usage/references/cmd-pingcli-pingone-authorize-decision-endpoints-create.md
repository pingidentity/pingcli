# `pingcli pingone authorize decision-endpoints create`
Create a new decision endpoint

## Synopsis

Create a new decision endpoint in a PingOne environment

```
pingcli pingone authorize decision-endpoints create [flags]
```

## Examples

```
# Create a new decision endpoint from a JSON file
  pingcli pingone authorize decision-endpoints create --environment-id <env-id> --from-file decision-endpoint.json
  ...
  pingcli pingone authorize decision-endpoints create --environment-id <env-id> --from-file decision-endpoint.json --name "My Endpoint" --description "Handles resource X" --record-recent-requests
```
