# `pingcli pingone gateways gateway-instances list`
...
```
pingcli pingone gateways gateway-instances list [flags]
```
...
# List all gateway instances for a gateway
  pingcli pingone gateways gateway-instances list --environment-id <env-id> --gateway-id <gateway-id>
```
