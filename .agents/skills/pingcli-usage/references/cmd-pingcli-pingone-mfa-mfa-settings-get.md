# `pingcli pingone mfa mfa-settings get`
Read MFA settings

## Synopsis

Read the MFA settings singleton for a PingOne environment

```
pingcli pingone mfa mfa-settings get [flags]
```

## Examples

```
# Read MFA settings for an environment
  pingcli pingone mfa mfa-settings get --environment-id <env-id>
```
