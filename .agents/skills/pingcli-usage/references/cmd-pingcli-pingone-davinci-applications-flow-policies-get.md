# `pingcli pingone davinci applications flow-policies get`
Read a DaVinci flow policy

## Synopsis

Read a specific DaVinci flow policy from a DaVinci application in a PingOne environment

```
pingcli pingone davinci applications flow-policies get [flags]
```

## Examples

```
# Read a specific DaVinci flow policy
  pingcli pingone davinci applications flow-policies get \
    --environment-id <env-id> \
    --application-id <app-id> \
    --flow-policy-id <flow-policy-id>
```
