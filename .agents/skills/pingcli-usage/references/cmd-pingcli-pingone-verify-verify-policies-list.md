# `pingcli pingone verify verify-policies list`
...
```
pingcli pingone verify verify-policies list [flags]
```
...
# List all verify policies in an environment
  pingcli pingone verify verify-policies list --environment-id <env-id>
```
