# `pingcli pingfederate data-stores get`
Read a specific data store

## Synopsis

Read a specific PingFederate data store

```
pingcli pingfederate data-stores get [flags]
```
...
```
# Read a specific data store
  pingcli pingfederate data-stores get --id <id>
```
