# `pingcli pingone verify verify-policies get`
...
```
pingcli pingone verify verify-policies get [flags]
```
...
```
# Read a specific verify policy
  pingcli pingone verify verify-policies get --environment-id <env-id> --verify-policy-id <policy-id>
```
