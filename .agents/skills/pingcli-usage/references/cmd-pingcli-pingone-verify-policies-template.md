# `pingcli pingone verify policies template`
...
```
pingcli pingone verify policies template [flags]
```
...
# Generate a template and save to a file
  pingcli pingone verify policies template > body.json
...
Example workflow:
  pingcli pingone verify policies template > body.json
  # edit body.json
  pingcli pingone verify policies create --from-file body.json
```
