# `pingcli pingone custom-domains create`
Create a new custom domain

## Synopsis

Create a new custom domain in a PingOne environment

```
pingcli pingone custom-domains create [flags]
```

## Examples

```
# Create a custom domain from a JSON file
