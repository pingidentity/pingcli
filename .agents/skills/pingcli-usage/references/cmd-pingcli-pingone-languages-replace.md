# `pingcli pingone languages replace`
Update a language

## Synopsis

Update (replace) a language in a PingOne environment

```
pingcli pingone languages replace [flags]
```

## Examples

```
# Update a language from a JSON file (--environment-id and --language-id are still required)
