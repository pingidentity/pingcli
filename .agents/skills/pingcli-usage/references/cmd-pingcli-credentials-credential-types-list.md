# `pingcli credentials credential-types list`
...
```
pingcli credentials credential-types list [flags]
```
...
# List all credential types in an environment
  pingcli credentials credential-types list --environment-id <env-id>
```
