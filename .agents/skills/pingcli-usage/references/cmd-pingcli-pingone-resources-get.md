# `pingcli pingone resources get`
Read a specific resource

## Synopsis

Read a specific resource in a PingOne environment

```
pingcli pingone resources get [flags]
```
...
```
# Read a specific resource
  pingcli pingone resources get --environment-id <env-id> --resource-id <resource-id>
```
