# `pingcli pingone resources application-resources replace`
Update an application resource

## Synopsis

Update (replace) an application resource in a PingOne environment

```
pingcli pingone resources application-resources replace [flags]
```

## Examples

```
# Update an application resource from a JSON file (--environment-id, --resource-id, and --application-resource-id are still required)
