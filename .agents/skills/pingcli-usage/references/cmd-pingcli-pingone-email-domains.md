...
```
pingcli pingone email-domains [flags]
```
...
|---------|-------------|----------|
| `pingcli pingone email-domains create` | Create a new trusted email domain | [`cmd-pingcli-pingone-email-domains-create.md`](cmd-pingcli-pingone-email-domains-create.md) |
| `pingcli pingone email-domains delete` | Delete a trusted email domain | [`cmd-pingcli-pingone-email-domains-delete.md`](cmd-pingcli-pingone-email-domains-delete.md) |
