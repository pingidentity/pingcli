...
# Create or update a digital wallet application from flags
  pingcli credentials digital-wallet-applications apply --environment-id <env-id> --name "My Wallet App" --app-open-url "https://example.com/open" --application-id <app-id>
