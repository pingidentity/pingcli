# `pingcli pingfederate administrative-accounts delete`
Delete an administrative account

## Synopsis

Delete a PingFederate administrative account

```
pingcli pingfederate administrative-accounts delete [flags]
```
...
```
# Delete an administrative account
  pingcli pingfederate administrative-accounts delete --username <username>
```
