# `pingcli pingone applications flow-policy-assignments list`
List all flow policy assignments

## Synopsis

List all flow policy assignments for an application in a PingOne environment

```
pingcli pingone applications flow-policy-assignments list [flags]
```

## Examples

```
# List all flow policy assignments for an application
  pingcli pingone applications flow-policy-assignments list --environment-id <env-id> --application-id <app-id>
```
