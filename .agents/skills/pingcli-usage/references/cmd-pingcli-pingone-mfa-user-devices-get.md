# `pingcli pingone mfa user-devices get`
...
```
pingcli pingone mfa user-devices get [flags]
```
...
```
# Read a specific user MFA device
  pingcli pingone mfa user-devices get --environment-id <env-id> --user-id <user-id> --device-id <device-id>
```
