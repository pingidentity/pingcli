# `pingcli pingone groups group-role-assignments list`
...
```
pingcli pingone groups group-role-assignments list [flags]
```
...
# List all group role assignments for a group in an environment
  pingcli pingone groups group-role-assignments list --environment-id <env-id> --group-id <group-id>
```
