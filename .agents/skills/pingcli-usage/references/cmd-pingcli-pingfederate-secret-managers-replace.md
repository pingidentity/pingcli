# `pingcli pingfederate secret-managers replace`
Update a secret manager

## Synopsis

Update (replace) a PingFederate secret manager

```
pingcli pingfederate secret-managers replace [flags]
```

## Examples

```
# Update a secret manager from a JSON file (--id is still required)
