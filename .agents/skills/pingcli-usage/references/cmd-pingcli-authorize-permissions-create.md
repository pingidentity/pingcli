# `pingcli authorize permissions create`
...
```
pingcli authorize permissions create [flags]
```
...
# Create a new application resource permission from flags
  pingcli authorize permissions create --environment-id <env-id> --application-resource-id <app-resource-id> --action read --description "Read access"

  # Create a new application resource permission from a JSON file
  pingcli authorize permissions create --environment-id <env-id> --application-resource-id <app-resource-id> --from-file permission.json
