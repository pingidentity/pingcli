# `pingcli pingone schemas schema-attributes list`
...
```
pingcli pingone schemas schema-attributes list [flags]
```
...
# List all schema attributes for a schema
  pingcli pingone schemas schema-attributes list --environment-id <env-id> --schema-id <schema-id>
```
