# `pingcli pingone notification-templates notification-template-contents list`
List all notification template contents

## Synopsis

List all notification template contents for a template in a PingOne environment

```
pingcli pingone notification-templates notification-template-contents list [flags]
```

## Examples

```
# List all notification template contents for a template
  pingcli pingone notification-templates notification-template-contents list --environment-id <env-id> --template-name <template-name>
```
