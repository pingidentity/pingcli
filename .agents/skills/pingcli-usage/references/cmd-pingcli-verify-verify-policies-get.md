# `pingcli verify verify-policies get`
...
```
pingcli verify verify-policies get [flags]
```
...
```
# Read a specific verify policy
  pingcli verify verify-policies get --environment-id <env-id> --verify-policy-id <policy-id>
```
