# `pingcli pingone sign-on-policies actions replace`
Update a sign-on policy action

## Synopsis

Update (replace) a sign-on policy action in a PingOne sign-on policy

```
pingcli pingone sign-on-policies actions replace [flags]
```
