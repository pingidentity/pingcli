# `pingcli pingfederate certificates groups template`
Generate a certificate group JSON template

## Synopsis

Generate a JSON skeleton template for certificate group import bodies

```
pingcli pingfederate certificates groups template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate certificates groups template > body.json

  # Edit the template, then import the certificate
  pingcli pingfederate certificates groups create --group-name <group-name> --from-file body.json
...
Example workflow:
  pingcli pingfederate certificates groups template > body.json
  # edit body.json
  pingcli pingfederate certificates groups create --from-file body.json
```
