# `pingcli credentials credential-types`
Credential Types
...
```
pingcli credentials credential-types [flags]
```
...
| `pingcli credentials credential-types replace` | Replace a credential type | [`cmd-pingcli-credentials-credential-types-replace.md`](cmd-pingcli-credentials-credential-types-replace.md) |
| `pingcli credentials credential-types template` | Generate a credential type JSON template | [`cmd-pingcli-credentials-credential-types-template.md`](cmd-pingcli-credentials-credential-types-template.md) |
