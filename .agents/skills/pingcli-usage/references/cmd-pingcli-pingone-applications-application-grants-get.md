# `pingcli pingone applications application-grants get`
...
```
pingcli pingone applications application-grants get [flags]
```
...
```
# Read a specific application grant
  pingcli pingone applications application-grants get --environment-id <env-id> --application-id <app-id> --application-grant-id <grant-id>
```
