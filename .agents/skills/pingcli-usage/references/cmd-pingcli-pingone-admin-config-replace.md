# `pingcli pingone admin-config replace`
Update administrator security

## Synopsis

Update (replace) the administrator security configuration for a PingOne environment

```
pingcli pingone admin-config replace [flags]
```
