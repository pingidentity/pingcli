# `pingcli pingone licenses list`
List all licenses

## Synopsis

List all PingOne licenses for an organization

```
pingcli pingone licenses list [flags]
```
...
# List all licenses for an organization
  pingcli pingone licenses list --organization-id <org-id>
```
