# `pingcli pingfederate authentication-api applications template`
Generate an authentication API application JSON template

## Synopsis

Generate a JSON skeleton template for authentication API application create or replace bodies

```
pingcli pingfederate authentication-api applications template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate authentication-api applications template > body.json

  # Edit the template, then create the authentication API application
  pingcli pingfederate authentication-api applications create --from-file body.json
