# `pingcli pingone notification-policies create`
Create a new notification policy

## Synopsis

Create a new notification policy in a PingOne environment

```
pingcli pingone notification-policies create [flags]
```

## Examples

```
# Create a new notification policy from a JSON file
