# `pingcli pingfederate authentication-api settings get`
Read authentication API settings

## Synopsis

Read the PingFederate Authentication API Settings singleton

```
pingcli pingfederate authentication-api settings get [flags]
```
