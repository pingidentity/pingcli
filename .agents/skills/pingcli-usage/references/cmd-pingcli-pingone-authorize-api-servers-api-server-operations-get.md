# `pingcli pingone authorize api-servers api-server-operations get`
...
```
pingcli pingone authorize api-servers api-server-operations get [flags]
```
...
```
# Read a specific API server operation
  pingcli pingone authorize api-servers api-server-operations get --environment-id <env-id> --api-server-id <server-id> --api-server-operation-id <operation-id>
```
