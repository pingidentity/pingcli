# `pingcli authorize application-roles get`
...
```
pingcli authorize application-roles get [flags]
```
...
```
# Read a specific application role
  pingcli authorize application-roles get --environment-id <env-id> --application-role-id <role-id>
```
