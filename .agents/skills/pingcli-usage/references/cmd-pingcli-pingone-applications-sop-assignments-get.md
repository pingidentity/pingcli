# `pingcli pingone applications sop-assignments get`
Read a specific sign-on policy assignment

## Synopsis

Read a specific sign-on policy assignment for an application in a PingOne environment

```
pingcli pingone applications sop-assignments get [flags]
```
...
```
# Read a specific sign-on policy assignment
  pingcli pingone applications sop-assignments get --environment-id <env-id> --application-id <app-id> --sop-assignment-id <assignment-id>
```
