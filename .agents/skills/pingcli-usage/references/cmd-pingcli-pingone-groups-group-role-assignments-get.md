# `pingcli pingone groups group-role-assignments get`
...
```
pingcli pingone groups group-role-assignments get [flags]
```
...
```
# Read a specific group role assignment
  pingcli pingone groups group-role-assignments get --environment-id <env-id> --group-id <group-id> --role-assignment-id <role-assignment-id>
```
