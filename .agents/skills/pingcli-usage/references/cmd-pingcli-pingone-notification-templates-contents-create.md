# `pingcli pingone notification-templates contents create`
Create a new notification template content

## Synopsis

Create a new notification template content in a PingOne environment

```
pingcli pingone notification-templates contents create [flags]
```
