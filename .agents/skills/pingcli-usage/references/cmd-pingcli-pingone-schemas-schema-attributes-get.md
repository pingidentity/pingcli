# `pingcli pingone schemas schema-attributes get`
...
```
pingcli pingone schemas schema-attributes get [flags]
```
...
```
# Read a specific schema attribute
  pingcli pingone schemas schema-attributes get --environment-id <env-id> --schema-id <schema-id> --attribute-id <attribute-id>
```
