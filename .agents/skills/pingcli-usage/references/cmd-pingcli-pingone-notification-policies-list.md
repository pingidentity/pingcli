# `pingcli pingone notification-policies list`
List all notification policies

## Synopsis

List all notification policies in a PingOne environment

```
pingcli pingone notification-policies list [flags]
```

## Examples

```
# List all notification policies in an environment
  pingcli pingone notification-policies list --environment-id <env-id>
```
