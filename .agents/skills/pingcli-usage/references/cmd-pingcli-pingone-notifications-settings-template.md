# `pingcli pingone notifications-settings template`
Generate a notifications settings JSON template

## Synopsis

Generate a JSON skeleton template for notifications settings replace bodies

```
pingcli pingone notifications-settings template [flags]
```
...
# Generate a template and save to a file
  pingcli pingone notifications-settings template > body.json
...
Example workflow:
  pingcli pingone notifications-settings template > body.json
  # edit body.json
  pingcli pingone notifications-settings replace --from-file body.json
```
