# `pingcli pingone protect risk-predictors get`
Read a specific risk predictor

## Synopsis

Read a specific risk predictor in a PingOne environment

```
pingcli pingone protect risk-predictors get [flags]
```
...
```
# Read a specific risk predictor
  pingcli pingone protect risk-predictors get --environment-id <env-id> --risk-predictor-id <predictor-id>
```
