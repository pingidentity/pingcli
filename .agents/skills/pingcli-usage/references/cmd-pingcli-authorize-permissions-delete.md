# `pingcli authorize permissions delete`
...
```
pingcli authorize permissions delete [flags]
```
...
```
# Delete an application resource permission
  pingcli authorize permissions delete --environment-id <env-id> --application-resource-id <app-resource-id> --application-resource-permission-id <permission-id>
```
