# `pingcli pingone users population apply`
Update user population

## Synopsis

Idempotently update the population assignment for a user in a PingOne environment. Apply is an alias for replace on this singleton resource.

```
pingcli pingone users population apply [flags]
```
