# `pingcli pingone users application-role-assignments create`
Create a new user application role assignment

## Synopsis

Create a new user application role assignment in a PingOne environment

```
pingcli pingone users application-role-assignments create [flags]
```

## Examples

```
# Create a new user application role assignment from a JSON file
