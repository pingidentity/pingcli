# `pingcli pingfederate authentication-api applications replace`
Update an authentication API application

## Synopsis

Update (replace) a PingFederate authentication API application

```
pingcli pingfederate authentication-api applications replace [flags]
```

## Examples

```
# Update an authentication API application from a JSON file (--id is still required)
