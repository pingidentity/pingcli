# `pingcli pingfederate key-pairs oauth-openid-connect template`
Generate an OAuth/OpenID Connect keys settings JSON template

## Synopsis

Generate a JSON skeleton template for OAuth/OpenID Connect keys settings replace bodies

```
pingcli pingfederate key-pairs oauth-openid-connect template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate key-pairs oauth-openid-connect template > body.json

  # Edit the template, then update the OAuth/OpenID Connect keys settings
  pingcli pingfederate key-pairs oauth-openid-connect replace --from-file body.json
