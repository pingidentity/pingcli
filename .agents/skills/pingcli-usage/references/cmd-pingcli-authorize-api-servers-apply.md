# `pingcli authorize api-servers apply`
...
```
pingcli authorize api-servers apply [flags]
```
...
# Create or update an API server (body supplies name, authorizationServer, and baseUrls)
  pingcli authorize api-servers apply --environment-id <env-id> --from-file api-server.json
