# `pingcli pingfederate authentication-api settings apply`
Update authentication API settings

## Synopsis

Idempotently update the PingFederate Authentication API Settings. Apply is an alias for replace on this singleton resource.

```
pingcli pingfederate authentication-api settings apply [flags]
```
