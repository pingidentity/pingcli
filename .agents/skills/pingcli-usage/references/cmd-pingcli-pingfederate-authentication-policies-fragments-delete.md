# `pingcli pingfederate authentication-policies fragments delete`
Delete an authentication policy fragment

## Synopsis

Delete a PingFederate authentication policy fragment

```
pingcli pingfederate authentication-policies fragments delete [flags]
```
...
```
# Delete an authentication policy fragment
  pingcli pingfederate authentication-policies fragments delete --id <id>
```
