# `pingcli pingone users user-role-assignments template`
...
```
pingcli pingone users user-role-assignments template [flags]
```
...
Example workflow:
  pingcli pingone users user-role-assignments template > body.json
  # edit body.json
  pingcli pingone users user-role-assignments create --from-file body.json
```
