# `pingcli davinci applications flow-policies list`
...
```
pingcli davinci applications flow-policies list [flags]
```
...
# List all DaVinci flow policies for an application in an environment
  pingcli davinci applications flow-policies list --environment-id <env-id> --application-id <app-id>
```
