# `pingcli pingone groups group-nestings get`
Read a specific group nesting

## Synopsis

Read a specific group nesting in a PingOne environment

```
pingcli pingone groups group-nestings get [flags]
```
...
```
# Read a specific group nesting
  pingcli pingone groups group-nestings get --environment-id <env-id> --group-id <group-id> --nested-group-id <nested-group-id>
```
