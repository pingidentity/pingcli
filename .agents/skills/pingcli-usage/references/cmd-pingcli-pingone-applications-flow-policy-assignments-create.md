# `pingcli pingone applications flow-policy-assignments create`
Create a new flow policy assignment

## Synopsis

Create a new flow policy assignment for an application in a PingOne environment

```
pingcli pingone applications flow-policy-assignments create [flags]
```
