# `pingcli authorize decision-endpoints get`
...
```
pingcli authorize decision-endpoints get [flags]
```
...
```
# Read a specific decision endpoint
  pingcli authorize decision-endpoints get --environment-id <env-id> --decision-endpoint-id <decision-endpoint-id>
```
