# `pingcli pingone protect risk-predictors template`
...
```
pingcli pingone protect risk-predictors template [flags]
```
...
Example workflow:
  ...
  # edit body.json
  pingcli pingone protect risk-predictors create --from-file body.json
```
