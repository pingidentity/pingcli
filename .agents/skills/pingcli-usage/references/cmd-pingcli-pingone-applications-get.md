...
Read a specific application in a PingOne environment

```
pingcli pingone applications get [flags]
```
...
```
# Read a specific application
  pingcli pingone applications get --environment-id <env-id> --application-id <app-id>
```
