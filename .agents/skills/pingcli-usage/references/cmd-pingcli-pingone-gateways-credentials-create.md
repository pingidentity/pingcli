# `pingcli pingone gateways credentials create`
...
```
pingcli pingone gateways credentials create [flags]
```
...
# Generate a new gateway credential JWT
  pingcli pingone gateways credentials create --environment-id <env-id> --gateway-id <gateway-id>
```
