# `pingcli pingfederate administrative-accounts template`
Generate an administrative account JSON template

## Synopsis

Generate a JSON skeleton template for administrative account create or replace bodies

```
pingcli pingfederate administrative-accounts template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate administrative-accounts template > body.json

  # Edit the template, then create the administrative account
  pingcli pingfederate administrative-accounts create --from-file body.json
