# `pingcli pingfederate oauth client-registration-policies create`
Create a new client registration policy

## Synopsis

Create a new PingFederate OAuth client registration policy

```
pingcli pingfederate oauth client-registration-policies create [flags]
```

## Examples

```
# Create a new client registration policy from a JSON file
  pingcli pingfederate oauth client-registration-policies create --from-file policy.json

  # Create a new client registration policy from stdin
  pingcli pingfederate oauth client-registration-policies create --from-file - < policy.json
