# `pingcli pingone agreements get`
Read a specific agreement

## Synopsis

Read a specific agreement in a PingOne environment

```
pingcli pingone agreements get [flags]
```
...
```
# Read a specific agreement
  pingcli pingone agreements get --environment-id <env-id> --agreement-id <agreement-id>
```
