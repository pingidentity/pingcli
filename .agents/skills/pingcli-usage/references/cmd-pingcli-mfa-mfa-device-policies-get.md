# `pingcli mfa mfa-device-policies get`
...
```
pingcli mfa mfa-device-policies get [flags]
```
...
```
# Read a specific MFA device policy
  pingcli mfa mfa-device-policies get --environment-id <env-id> --mfa-device-policy-id <policy-id>
```
