# `pingcli mfa fido2-policies create`
Create a new FIDO2 policy

## Synopsis

Create a new FIDO2 policy in a PingOne environment

```
pingcli mfa fido2-policies create [flags]
```

## Examples

```
# Create a new FIDO2 policy from a JSON file
  pingcli mfa fido2-policies create --environment-id <env-id> --from-file fido2-policy.json
  ...
  pingcli mfa fido2-policies create --environment-id <env-id> --name "Default FIDO2 Policy" --relying-party-id example.com --from-file fido2-policy.json
```
...
- [`pingcli mfa fido2-policies`](cmd-pingcli-mfa-fido2-policies.md) — FIDO2 Policies
