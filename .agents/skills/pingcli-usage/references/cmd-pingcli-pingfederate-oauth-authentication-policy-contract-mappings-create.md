# `pingcli pingfederate oauth authentication-policy-contract-mappings create`
Create a new authentication policy contract mapping

## Synopsis

Create a new PingFederate OAuth authentication policy contract mapping

```
pingcli pingfederate oauth authentication-policy-contract-mappings create [flags]
```

## Examples

```
# Create a new authentication policy contract mapping from a JSON file
