# `pingcli pingone credentials digital-wallet-applications list`
List all digital wallet applications

## Synopsis

List all digital wallet applications in a PingOne environment

```
pingcli pingone credentials digital-wallet-applications list [flags]
```

## Examples

```
# List all digital wallet applications in an environment
  pingcli pingone credentials digital-wallet-applications list --environment-id <env-id>
```
