# `pingcli pingfederate oauth authorization-detail-types create`
Create a new authorization detail type

## Synopsis

Create a new PingFederate OAuth authorization detail type

```
pingcli pingfederate oauth authorization-detail-types create [flags]
```

## Examples

```
# Create a new authorization detail type from a JSON file
