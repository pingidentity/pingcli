# `pingcli pingfederate version get`
Read PingFederate version

## Synopsis

Read the PingFederate Version singleton

```
pingcli pingfederate version get [flags]
```
...
- [`pingcli pingfederate version`](cmd-pingcli-pingfederate-version.md) — PingFederate Version
