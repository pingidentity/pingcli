# `pingcli pingfederate authentication-policies settings apply`
Update authentication policies settings

## Synopsis

Idempotently update the PingFederate Authentication Policies Settings. Apply is an alias for replace on this singleton resource.

```
pingcli pingfederate authentication-policies settings apply [flags]
```
