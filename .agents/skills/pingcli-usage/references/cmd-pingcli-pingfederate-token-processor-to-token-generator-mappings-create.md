# `pingcli pingfederate token-processor-to-token-generator-mappings create`
Create a new token processor to token generator mapping

## Synopsis

Create a new PingFederate token processor to token generator mapping

```
pingcli pingfederate token-processor-to-token-generator-mappings create [flags]
```

## Examples

```
# Create a new token processor to token generator mapping from a JSON file
