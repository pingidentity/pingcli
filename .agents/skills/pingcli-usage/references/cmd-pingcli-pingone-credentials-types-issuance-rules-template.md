# `pingcli pingone credentials types issuance-rules template`
...
```
pingcli pingone credentials types issuance-rules template [flags]
```
...
# Generate a template and save to a file
  pingcli pingone credentials types issuance-rules template > body.json
...
Example workflow:
  pingcli pingone credentials types issuance-rules template > body.json
  # edit body.json
  pingcli pingone credentials types issuance-rules create --from-file body.json
```
