# `pingcli pingone webhooks get`
Read a specific webhook

## Synopsis

Read a specific webhook in a PingOne environment

```
pingcli pingone webhooks get [flags]
```
...
```
# Read a specific webhook
  pingcli pingone webhooks get --environment-id <env-id> --webhook-id <webhook-id>
```
