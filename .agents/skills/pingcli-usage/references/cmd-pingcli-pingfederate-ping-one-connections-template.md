# `pingcli pingfederate ping-one-connections template`
Generate a PingOne connection JSON template

## Synopsis

Generate a JSON skeleton template for PingOne connection create or replace bodies

```
pingcli pingfederate ping-one-connections template [flags]
```
...
# Generate a template and save to a file
  pingcli pingfederate ping-one-connections template > body.json

  # Edit the template, then create the PingOne connection
  pingcli pingfederate ping-one-connections create --from-file body.json
