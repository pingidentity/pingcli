# `pingcli pingone password-policies get`
Read a specific password policy

## Synopsis

Read a specific password policy in a PingOne environment

```
pingcli pingone password-policies get [flags]
```
...
```
# Read a specific password policy
  pingcli pingone password-policies get --environment-id <env-id> --password-policy-id <policy-id>
```
