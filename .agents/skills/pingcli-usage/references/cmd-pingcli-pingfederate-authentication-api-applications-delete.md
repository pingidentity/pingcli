# `pingcli pingfederate authentication-api applications delete`
Delete an authentication API application

## Synopsis

Delete a PingFederate authentication API application

```
pingcli pingfederate authentication-api applications delete [flags]
```
...
```
# Delete an authentication API application
  pingcli pingfederate authentication-api applications delete --id <id>
```
