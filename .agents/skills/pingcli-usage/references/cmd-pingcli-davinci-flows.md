...
|---------|-------------|----------|
| `pingcli davinci flows apply` | Create or update a DaVinci flow | [`cmd-pingcli-davinci-flows-apply.md`](cmd-pingcli-davinci-flows-apply.md) |
| `pingcli davinci flows clone` | Clone a DaVinci flow | [`cmd-pingcli-davinci-flows-clone.md`](cmd-pingcli-davinci-flows-clone.md) |
