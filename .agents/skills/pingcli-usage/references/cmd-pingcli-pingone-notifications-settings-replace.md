# `pingcli pingone notifications-settings replace`
Update notifications settings

## Synopsis

Update (replace) the notifications settings configuration for a PingOne environment

```
pingcli pingone notifications-settings replace [flags]
```
