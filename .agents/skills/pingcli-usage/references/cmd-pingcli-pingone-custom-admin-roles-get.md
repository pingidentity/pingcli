# `pingcli pingone custom-admin-roles get`
Read a specific custom admin role

## Synopsis

Read a specific custom admin role in a PingOne environment

```
pingcli pingone custom-admin-roles get [flags]
```
...
```
# Read a specific custom admin role
  pingcli pingone custom-admin-roles get --environment-id <env-id> --custom-admin-role-id <role-id>
```
