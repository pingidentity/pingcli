# `pingcli pingone gateways get`
Read a specific gateway

## Synopsis

Read a specific gateway in a PingOne environment

```
pingcli pingone gateways get [flags]
```
...
```
# Read a specific gateway
  pingcli pingone gateways get --environment-id <env-id> --gateway-id <gateway-id>
```
