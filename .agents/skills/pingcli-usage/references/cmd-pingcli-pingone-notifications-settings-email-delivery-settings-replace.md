# `pingcli pingone notifications-settings email-delivery-settings replace`
Update notifications settings SMTP

## Synopsis

Update (replace) the notifications settings SMTP email delivery configuration for a PingOne environment

```
pingcli pingone notifications-settings email-delivery-settings replace [flags]
```
