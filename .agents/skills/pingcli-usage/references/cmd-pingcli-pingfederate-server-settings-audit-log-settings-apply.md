# `pingcli pingfederate server-settings audit-log-settings apply`
Update audit log settings

## Synopsis

Idempotently update the PingFederate Audit Log Settings. Apply is an alias for replace on this singleton resource.

```
pingcli pingfederate server-settings audit-log-settings apply [flags]
```
