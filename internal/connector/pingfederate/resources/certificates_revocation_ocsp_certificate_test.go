...
func TestableResource_PingFederateCertificatesRevocationOcspCertificate(t *testing.T) *testutils_resource.TestableResource {
	t.Helper()
...
func Test_PingFederateCertificatesRevocationOcspCertificate(t *testing.T) {
	tr := TestableResource_PingFederateCertificatesRevocationOcspCertificate(t)
