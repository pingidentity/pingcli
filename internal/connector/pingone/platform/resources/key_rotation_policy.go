...
func (r *PingOneKeyRotationPolicyResource) getKeyRotationPolicyData() (map[string]string, error) {
	...
	apiObjs, err := pingone.GetManagementAPIObjectsFromIterator[management.KeyRotationPolicy](iter, "GetKeyRotationPolicies", "GetKeyRotationPolicies", r.ResourceType())
	if err != nil {
		return nil, err
	}

	for _, keyRotationPolicy := range apiObjs {
