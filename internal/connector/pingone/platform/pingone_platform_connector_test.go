...
func TestPlatformTerraformPlan(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			ignoredErrors: []string{
				"Error: The language code `pt` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `fr` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `es` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `pl` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `hu` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `cs` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `ru` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `ko` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `th` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `tr` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `fr-CA` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `de` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `it` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `ja` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `zh` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `en` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
				"Error: The language code `nl` is reserved and cannot be imported into this provider.  Please use `pingone_language_update` for system-defined languages instead.",
			},
		},
		{
			name:             "LanguageUpdate",
