...
func TestAuthorizeTrustFrameworkConditionExport(t *testing.T) {
	...
	expectedImportBlocks := []connector.ImportBlock{
		{
			ResourceType: "pingone_authorize_trust_framework_condition",
			ResourceName: "Test Authorize Trust Framework Condition",
