...
func Test_MfaFido2Policy(t *testing.T) {
	clientInfo := testutils.GetClientInfo(t)

	tr := pingone_mfa_testable_resources.MfaFido2Policy(t, clientInfo)
	...
	// Existing MFA FIDO2 Policies are generated, test subset.
