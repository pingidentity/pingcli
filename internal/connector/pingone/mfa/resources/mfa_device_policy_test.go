...
func Test_MfaDevicePolicy(t *testing.T) {
	clientInfo := testutils.GetClientInfo(t)

	tr := pingone_mfa_testable_resources.MfaDevicePolicy(t, clientInfo)
	...
	// Existing MFA Device Policies are generated, test subset.
