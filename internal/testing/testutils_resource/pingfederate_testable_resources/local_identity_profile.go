...
func createLocalIdentityProfile(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, strArgs ...string) testutils_resource.ResourceCreationInfo {
	t.Helper()
...
func deleteLocalIdentityProfile(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, ids ...string) {
	...
	if len(ids) != 1 {
		t.Fatalf("Unexpected number of arguments provided to deleteLocalIdentityProfile(): %v", ids)
	}
	id := ids[0]
