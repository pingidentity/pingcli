...
func createAuthenticationApiApplication(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, strArgs ...string) testutils_resource.ResourceCreationInfo {
	t.Helper()
...
func deleteAuthenticationApiApplication(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, ids ...string) {
	...
	if len(ids) != 1 {
		t.Fatalf("Unexpected number of arguments provided to deleteAuthenticationApiApplication(): %v", ids)
	}
	id := ids[0]
