...
func createNotificationPolicy(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, strArgs ...string) testutils_resource.ResourceCreationInfo {
	t.Helper()
...
func deleteNotificationPolicy(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, ids ...string) {
	...
	request := clientInfo.PingOneApiClient.ManagementAPIClient.NotificationsPoliciesApi.DeleteNotificationsPolicy(clientInfo.PingOneContext, clientInfo.PingOneExportEnvironmentID, id)
