...
func Group(t *testing.T, clientInfo *connector.ClientInfo) *testutils_resource.TestableResource {
	t.Helper()
	...
	return &testutils_resource.TestableResource{
		...
		Dependencies:       nil,
		ExportableResource: resources.Group(clientInfo),
	}
}

func createGroup(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, strArgs ...string) testutils_resource.ResourceInfo {
	t.Helper()
	...
	clientStruct := management.Group{
		Name:        groupName,
		Description: utils.Pointer("This is a test group"),
	...
	request = request.Group(clientStruct)
...
func deleteGroup(t *testing.T, clientInfo *connector.ClientInfo, resourceType string, ids ...string) {
	t.Helper()
