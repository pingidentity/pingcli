...
func (UnimplementedPingCliCommandServer) Configuration(context.Context, *Empty) (*PingCliCommandConfigurationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Configuration not implemented")
}
...
func RegisterPingCliCommandServer(s grpc.ServiceRegistrar, srv PingCliCommandServer) {
	// If the following call panics, it indicates UnimplementedPingCliCommandServer was
...
func (UnimplementedLoggerServer) UserError(context.Context, *LoggerRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UserError not implemented")
}
func (UnimplementedLoggerServer) UserFatal(context.Context, *LoggerRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UserFatal not implemented")
}
func (UnimplementedLoggerServer) PluginError(context.Context, *LoggerRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PluginError not implemented")
}
...
const (
	Authentication_GetToken_FullMethodName = "/Authentication/GetToken"
)
...
type AuthenticationClient interface {
	GetToken(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AuthenticationToken, error)
}
...
func (c *authenticationClient) GetToken(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*AuthenticationToken, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthenticationToken)
	err := c.cc.Invoke(ctx, Authentication_GetToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthenticationServer interface {
	GetToken(context.Context, *Empty) (*AuthenticationToken, error)
...
func (UnimplementedAuthenticationServer) GetToken(context.Context, *Empty) (*AuthenticationToken, error) {
...
func _Authentication_GetToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Authentication_GetToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).GetToken(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
