...
| service.pingOne.authentication.authCode.redirectURI | ENUM_STRING | | The redirect URI configured for the authorization code client application.<br><br>Example: `http://localhost:7464/callback` |
