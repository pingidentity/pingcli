...
| `service.pingone.authentication.authorizationCode.scopes` | `--pingone-oidc-authorization-code-scopes` | PINGCLI_PINGONE_OIDC_AUTHORIZATION_CODE_SCOPES | String Array | The authorization code scope(s) used to authenticate to the PingOne management API.
